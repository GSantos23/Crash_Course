...
class RandomWalk():
	...
	def get_step(self):
		""" To calculate direction and distance"""
		direction = choice([5, -5])
	...
	def fill_walk(self):
		...
		# Keep taking steps until the reaches the desired length"""
